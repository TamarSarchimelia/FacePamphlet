...
public class FacePamphletProfile implements FacePamphletConstants {
	...
	private String birthday = EMPTY_LABEL_TEXT;
	...
	public String toString() {
		...
		// You fill this in. Currently always returns the empty string.
		String string=null;
		for (String s:friendslist) if (string==null) string=profilename + " (" + namestatus + ")"+birthday+" : "+s;else string+=", "+s;
		
		if (string==null) return profilename + " (" + namestatus + ")"+birthday+" : ";
